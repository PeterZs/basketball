...
env_cls = "ICCGANRebound"
env_params = dict(
    character_model = "assets/humanoid_hands.xml",
    motion_file = ["assets/defense_standby.yaml"],
    goal_reward_weight=0.9,
    ob_horizon = 2
)
...
discriminators = {
    "rebound/body": dict(
        ...
        parent_link = None,
        motion_file = ["assets/dribble2shoot_truncated.yaml", "assets/defense_standby2.yaml", "assets/catch.yaml"],
        weight = 0.08
    ),
    "rebound/fingers": dict(
        key_links = [
            [
        ...
        motion_file = ["assets/defense_standby.yaml", "assets/catch.yaml"],
        weight = 0.02
    )
}
